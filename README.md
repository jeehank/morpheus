...
- [`src/services/supabaseClient.ts`](file:///c:/Users/JEEHAN/Downloads/morpheusprep/src/services/supabaseClient.ts) — Supabase database and auth service. Manages user registration, login, session persistence, email verification, review submission, profanity filtering, report handling, watchlist sync, and admin user management.
