      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <span style={{ fontWeight: 700, fontSize: '1.05rem', color: '#fff' }}>
              {mode === 'signin' ? 'Sign In to IGMDb' : mode === 'register' ? 'Create Account' : 'Verify Email Address'}
            </span>
          </div>
        ...
        <div style={{
          ...
          <span style={{ display: 'flex', alignItems: 'center', gap: '4px' }}>
            ...
            Your IP Address: <strong style={{ color: '#fff' }}>{clientIp}</strong>
          </span>
          <span style={{ color: 'var(--brand-orange)', fontWeight: 600 }}>Max 1 Account / IP</span>
        </div>
        ...
        <div style={{ padding: '24px' }}>
          ...
          {mode === 'register' && (
            <form onSubmit={handleRegisterSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
              ...
              <div style={{ fontSize: '0.75rem', color: '#aaa', backgroundColor: '#121212', padding: '8px 12px', borderRadius: '6px', borderLeft: '3px solid var(--brand-orange)' }}>
                ℹ️ Standard email accounts require entering a 6-digit verification code to post reviews. (Google sign-ins are verified instantly).
              </div>
              ...
              >
                {isLoading ? 'Creating Account...' : 'Register & Get Verification Code'}
              </button>
